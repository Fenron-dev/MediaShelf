...
final documentPositionsDaoProvider = Provider((ref) => ref.watch(databaseProvider).documentPositionsDao);
final mediaBookmarksDaoProvider = Provider((ref) => ref.watch(databaseProvider).mediaBookmarksDao);
